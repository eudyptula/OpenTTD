...
static const SaveLoad _company_desc[] = {
	...
	SLE_CONDARR(CompanyProperties, yearly_expenses,       SLE_INT64, 3 * 13,                  2, 196),
	SLE_CONDARR(CompanyProperties, yearly_expenses,       SLE_INT64, 3 * 15,                196, SL_MAX_VERSION),
...
static const SaveLoad _company_settings_desc[] = {
	...
	SLE_CONDARR(Company, settings.infrastructure_sharing, SLE_BOOL, 4, 196, SL_MAX_VERSION),
	SLE_CONDARR(Company, settings.sharing_fee,            SLE_UINT32, 4, 196, SL_MAX_VERSION),
...
static const SaveLoad _company_settings_skip_desc[] = {
	...
	/* Infrastructure sharing settings */
	SLE_CONDNULL(4, 196, SL_MAX_VERSION),    // settings.infrastructure_sharing
	SLE_CONDNULL(16, 196, SL_MAX_VERSION),    // settings.sharing_fee
